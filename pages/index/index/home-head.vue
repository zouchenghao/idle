<template>
  <!-- 首页标题栏，轮播图整合插件 -->
  <view class="banner-swiper-wrap po-re">
    <!-- 城市选择 -->
    <view class="flex-cc m-bc-fff pr10 pt10 pb10" style="border-top: 1px solid #eee">
      <view class="city-select" style="padding: 10rpx 20rpx;width: 200rpx" @click="$Router.push('pages/public/city-select')">
      {{ currentCity }}
      <u-icon name="arrow-down pl10"></u-icon>
    </view>
    <view class="flex-1" @tap="$Router.push('/pages/public/search')">
      <u-search shape="round" disabled :show-action="false"></u-search>
    </view>
    
    </view>
    
    <!-- 标题栏 -->
    <!-- <view class="container po-ab" style="width: 100%;top: 60rpx;z-index: 1000" >
      <u-sticky h5-nav-height="0" bg-color="transparent">
        <view class="u-navbar-inner" :style="[navbarStyle]">
...
export default {
  ...
  computed: {
    ...
    navbarStyle() {
      ...
      style.background = this.changeNavBackground
        ? `url(${this.navBgImage}) no-repeat top / 100% auto`
        : "none";
